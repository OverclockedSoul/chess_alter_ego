...
Define the requirements for the Maia2-based `restible` chess bot repository, including data export, dataset preparation, fine-tuning, evaluation, inference, and lichess-bot integration.
